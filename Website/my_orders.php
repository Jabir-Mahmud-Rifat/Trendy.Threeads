...
<body>
                ...
                <ul class="nav-list">
                    <li class="nav-item">
                        ...
                        <div class="user-content">
                            ...
                            <a href="..\Website\delivery_tracking.php"><h6>delivery tracking</h6></a>
    ...
    <section class="banner">
        <h2> <span> view</span> your  orders </h2>
        <p style="padding-bottom: 10px"> your choice is our priority </p>
